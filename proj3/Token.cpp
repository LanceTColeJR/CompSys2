 ...
 * Author: Lance Cole                       *
 * Date: 01/21/2025                           *
 * PURPOSE: write getToken function     *
 *******************************************/
...
//Functoion to skip lines, took code from class and wrote standalone function
...
void Token::get(istream &is)
{
  ...
  // Build automata if one is not provided
  if(DFA==NULL)
    {
      DFA = new int*[256];
	...
	//Start at state 0 and define char
...
//cout << "in lexeme loop. char = "<< int(ch) << endl; this is here to test
  }
